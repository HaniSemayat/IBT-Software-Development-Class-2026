...
#          Branch
#
# Each branch can have accounts and child branches.
...
class Branch:
    ...
    def __init__(self, name):
        ...
        # Store smaller branches
        self.children = []

        # Store accounts in this branch
        self.accounts = []
    ...
    # Add current branch accounts
    # Then add all child branch balances
...
# 1003 paid 1004
#
# Graph fits because relationships can connect anywhere.
...
def bfs(graph, start):
    ...
    while queue:
        ...
        if account not in visited:
            ...
            queue.extend(graph.get(account, []))
...
east_region.add_child(addis_branch)


# Add accounts to different levels

head_office.add_account(savings)

addis_branch.add_account(current)
